...
#'
#' \code{modGetPathRow} reads the official name of a modis image and returns the path and row data
#' as Modis name convention of horizontal and vertical "hXXvYY"
#'
#' @param str the full path or official image name of the Modis image from which the path and row is extracted
#'
#' @return an string with the path and row of the image in "hXXvYY" format
#'
#' @examples
