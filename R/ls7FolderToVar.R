...
#'  \code{\link{lsMosaic}} function). If \code{getStack = TRUE} is assigned 
...
#'  \code{\link{varEVI}}, ...)
#'
#' @param src \code{character} class argument containing the path to the folder with the Landsat multispectral image.
#' @param fun function defined for computing indexes.
#' All functions created in RGISTools with
#' 'var' prefix are avaliable functions. Custom functions can be also
