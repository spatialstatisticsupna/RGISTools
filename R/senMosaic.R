...
#' by the argument \code{out.name}. If no name is provided, "outfile" is the default value.
#'
...
#' process is faster using \code{gutils}, but it requiers the correct installation of \code{gdalUtils} library.
